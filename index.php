...
<html lang="<?php echo getLang('locale_lang') ?>" class="html">
  ...
  <body style="position: relative" class="body index">
    ...
    <div class="page js-page">
      <picture>
        <img src="/assets/images/page-bg-lg.webp" fetchpriority="high" alt="bg" class="absolute top-0 left-0 right-0 -z-1 w-full h-auto" width="750" height="434" />
      </picture>
        ...
        <nav class="sw-container flex items-center justify-between h-14 sm:h-19" aria-label="Main navigation">
          <ul class="flex items-center w-full gap-8 font-medium">
            ...
            <li class="hidden lg:block">
              <a href="<?php echo getHref('') ?>" class="hover:text-gray-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300"><?php echo getLang('menu_home'); ?></a>
            </li>
            <li class="hidden lg:block">
          ...
          <button id="header-menu-btn" type="button"
            class="lg:hidden inline-flex items-center justify-center p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all duration-300" aria-controls="mobile-menu"
      ...
      <main>
        <section class="sw-container pt-12 lg:pt-6">
          <div class="lg:flex lg:gap-12 xl:gap-32 pb-12 lg:pb-24">
            <div class="lg:mt-8 xl:mt-20 mx-auto text-center">
              ...
              <p class="text-lg md:text-xl mb-8 xl:mb-16 max-w-xl text-white/60 leading-[1.4]">
                <?php echo getLang('hero_text'); ?>
              </p>

              <div class="flex mb-6 pb-2 overflow-auto">
                <img src="/assets/images/method_google-pay.png" alt="Google Pay" class="m-auto" width="92" height="34" loading="lazy" />
                <img src="/assets/images/method_pay-pal.png" alt="Pay Pal" class="m-auto" width="92" height="34" loading="lazy" />
                <img src="/assets/images/method_motional.png" alt="Motional" class="m-auto" width="92" height="34" loading="lazy" />
                <img src="/assets/images/method_visa.png" alt="VISA" class="m-auto" width="92" height="34" loading="lazy" />
                <img src="/assets/images/method_mastercard.png" alt="Mastercard" class="m-auto" width="92" height="34" loading="lazy" />
              </div>
            </div>
          </div>
        </section>
          ...
          <section class="sw-container">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-8 lg:mb-12 text-gray-300">
              <div class="inline-flex items-center gap-2 px-4 py-2 border border-[#FFFFFF1F] rounded-full bg-[#FFFFFF14]">
                <img src="/assets/images/swipe.svg" alt="swipe" class="m-auto" width="18" height="18" loading="lazy" />
                <span class="text-sm text-white"><?php echo getLang('badge_step_by_step_guidance'); ?></span>
              </div>

              <div class="inline-flex items-center gap-2 px-4 py-2 border border-[#FFFFFF1F] rounded-full bg-[#FFFFFF14]">
                <img src="/assets/images/card.svg" alt="card" class="m-auto" width="18" height="18" loading="lazy" />
                <span class="text-sm text-white"><?php echo getLang('badge_easy_credit_card_payments'); ?></span>
              </div>

              <div class="inline-flex items-center gap-2 px-4 py-2 border border-[#FFFFFF1F] rounded-full bg-[#FFFFFF14]">
                <img src="/assets/images/btn.svg" alt="btn" class="m-auto" width="18" height="18" loading="lazy" />
            ...
            <ol id="sw-how-to-by-slider" class="hide-scroll flex overflow-auto justify-around gap-8 pb-4 lg:pb-0">
              <li class="text-center min-w-full lg:min-w-auto">
                <div class="mb-6">
                  <picture>
                    <img src="/assets/images/step-1--desk.webp" alt="Step 1 illustration" class="m-auto w-64 min-w-64" width="225" height="327" loading="lazy" />
                  </picture>
                </div>
              ...
              <li class="text-center min-w-full lg:min-w-auto j-lazy-slide" data-step-number="2">
                <div class="mb-6">
                  <picture class="hidden lg:block">
                    <img src="/assets/images/step-2--desk.webp" alt="Step 2 illustration" class="m-auto w-64 min-w-64" width="225" height="327" loading="lazy" />
                  </picture>
              ...
              <li class="text-center min-w-full lg:min-w-auto j-lazy-slide" data-step-number="3">
                <div class="mb-6">
                  <picture class="hidden lg:block">
                    <img src="/assets/images/step-3--desk.webp" alt="Step 3 illustration" class="m-auto w-64 min-w-64" width="225" height="327" loading="lazy" />
                  </picture>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6">
              <div class="flex flex-col gap-2 md:gap-6">
                <div class="rounded-2xl bg-gray-100/80 max-w-md md:max-w-none m-auto">
                  <picture>
                    <img src="/assets/images/1.webp" alt="Payment methods" class="m-auto" width="620" height="372" loading="lazy" />
                  </picture>
                ...
                <div class="rounded-2xl bg-gray-100/80 grow max-w-md md:max-w-none m-auto">
                  <picture>
                    <img src="/assets/images/2.png" alt="Dialog with client" class="m-auto" width="620" height="202" loading="lazy" />
                  </picture>
              ...
              <div class="flex flex-col gap-2 md:gap-6">
                <div class="rounded-2xl bg-gray-100/80 max-w-md md:max-w-none m-auto">
                  <picture>
                    <img src="/assets/images/3.webp" alt="Currency pair" class="m-auto" width="620" height="211" loading="lazy" />
                  </picture>
                ...
                <div class="rounded-2xl bg-[linear-gradient(108.26deg,#5D5FEF_13.74%,#48C6EF_97.27%)] md:p-8 grow max-w-md md:max-w-none m-auto">
                  <picture>
                    <img src="/assets/images/4.webp" alt="Low Fees" class="m-auto" width="555" height="315" loading="lazy" />
                  </picture>
            ...
            <div class="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-30 items-center">
              <div class="">
                <div class="relative max-w-xl mx-auto">
                  <picture>
                    <img src="/assets/images/img_1.webp" alt="Mobile Interface" class="m-auto max-w-64 sm:max-w-none" width="388" height="756" loading="lazy" />
                  </picture>
                </div>
              </div>
              ...
              <div class="">
                ...
                <div>
                  <div class="flex mb-3">
                    <img src="/assets/images/btn--black.svg" alt="Button icon" class="mr-2" width="20" height="20" loading="lazy" />
                  ...
                  <div class="flex mb-3">
                    <img src="/assets/images/swipe--black.svg" alt="Swipe icon" class="mr-2" width="20" height="20" loading="lazy" />
                    <div class="font-medium">
        ...
        <div id="currency-table" class="sw-container-wrapper relative">
          <picture>
            <img src="/assets/images/bg.jpg" alt="bg" class="absolute top-0 left-0 right-0 -z-1 w-full h-auto" width="750" height="434" loading="lazy" />
          </picture>
          ...
          <section class="sw-container py-12 lg:py-28">
            <div class="md:flex justify-between items-end mb-4 md:mb-10">
              ...
              <a href="<?php echo getHref('login') ?>" class="flex gap-2 py-3 md:py-0 transition-all hover:scale-102">
                <span class="text-white font-medium"><?php echo getLang('top10_all_cryptocurrencies'); ?></span>
                <img src="/assets/images/arrow-up-right.svg" alt="away" width="18" height="18" loading="lazy" />
              </a>
            </div>
            ...
            <ul class="divide-y divide-white/10">
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="NOT" src="/assets/images/NOT.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                ...
                <div class="flex items-center gap-6">
                  <a href="<?php echo getHref('login') ?>" class="px-5 py-3 rounded-xl border border-[#FFFFFF1F] bg-white/10 hover:bg-white/20 text-white text-sm font-medium transition"
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="TONCOIN" src="/assets/images/TONCOIN.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      TON
                    </div>
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="BTC" src="/assets/images/BTC.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      BTC
                    </div>
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="USDT20" src="/assets/images/USDT20.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      USDT
                    </div>
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="XLM" src="/assets/images/XLM.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      XLM
                    </div>
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="ETH" src="/assets/images/ETH.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      ETH
                    </div>
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="SOL" src="/assets/images/SOL.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      SOL
                    </div>
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="LTC" src="/assets/images/LTC.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      LTC
                    </div>
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="TRX" src="/assets/images/TRX.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      TRX
                    </div>
              ...
              <li class="flex items-center justify-between py-4 first:border-t last:border-b border-white/10">
                <div class="flex items-center gap-4 min-w-0">
                  <img alt="XRP" src="/assets/images/XRP.svg" width="44" height="44" class="rounded-full h-11 w-11 border-2 border-white/20" loading="lazy" />
                  <div class="sm:flex">
                    <div class="text-white text-lg md:text-xl font-medium truncate mr-4">
                      XRP
                    </div>
        ...
        <div class="sw-container-wrapper bg-white mb-2 py-12 lg:py-20">
          <section class="sw-container mb-16 lg:mb-28">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                <div class="mb-4">
                  <div class="inline-flex items-center gap-2 px-4 py-2 border border-slate-200 rounded-full bg-slate-100">
                    <img src="/assets/images/card--dark.svg" alt="card" class="m-auto" width="18" height="18" loading="lazy" />
              ...
              <div>
                <picture>
                  <img src="/assets/images/img-secure.webp" alt="Cryptocurrency selection interface" class="m-auto" width="636" height="520" loading="lazy" />
                </picture>
              </div>
            </div>
          </section>
              ...
              <ul class="mb-6 md:mb-10 flex flex-col items-center">
                <li class="group js-faq-item sw-faq-details inline-block lg:px-0 mt-2 rounded-2xl focus-within:outline-1 focus-within:outline-slate-200 w-full">
                  <details class="peer rounded-t-2xl overflow-hidden bg-slate-100">
                    <summary class="p-6 pb-4 flex items-center justify-between cursor-pointer select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300">
                      <h3 class="md:text-xl font-medium" itemprop="name">
                        <?php echo getLang('faq_q1'); ?>
                      </h3>
                      <svg class="w-6 h-6 text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <footer class="text-white">
      <div class="sw-container py-10 md:py-16">
        <nav class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 md:mb-14">
          <div class="flex gap-8 md:gap-30">
            <ul class="space-y-4 text-sm">
              <li>
                <a href="<?php echo getHref('privacy') ?>" class="block hover:text-white/50"><?php echo getLang('menu_privacy'); ?></a>
              </li>

              <li>
                <a href="<?php echo getHref('terms') ?>" class="block hover:text-white/50"><?php echo getLang('menu_terms'); ?></a>
              </li>
            </ul>

            <div class="space-y-4">
              <a href="<?php echo getHref('') ?>" class="block text-white hover:text-white/50 text-sm"><?php echo getLang('menu_home'); ?></a>
              <a href="<?php echo getHref('about') ?>" class="block text-white hover:text-white/50 text-sm"><?php echo getLang('menu_about'); ?></a>
              <a href="<?php echo getHref('login') ?>" class="block text-white hover:text-white/50 text-sm"><?php echo getLang('menu_contact'); ?></a>
            </div>
          </div>
        ...
        <div class="pt-6">
          <span style="font-weight: bold; font-size: 2.7rem" class="mb-6"><?php echo getLang('logo_name'); ?></span>
